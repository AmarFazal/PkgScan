...
// Save the data collected from controllers and update the record
  void saveData() {
    ...
    imageValues.forEach((key, value) {
      ...
      print("This is the value of Image $value");
    });
    _controllers.forEach((key, controller) {
      updatedData[key] = controller.text; // Assuming the value is in the controller's text
    });

    // Send the updated data to the server
    widget.isNew == false
        ? _recordService.updateRecord(
            context, widget.entitiesId, widget.recordId, updatedData, oldValues)
